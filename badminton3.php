...
$fileName = sprintf("page3.%s.html", $date);

// 开始时间1（hour）
$startTime1 = $infos[2]['time']['time1'];
// 开始时间2（hour）
$startTime2 = $infos[2]['time']['time2'];

// 特定场地1
$specialFieldNum1 = $infos[2]['field']['num1'];
// 特定场地2
$specialFieldNum2 = $infos[2]['field']['num2'];

// cookie信息
$cookie = $infos[2]['cookie'];
